...
The study period of this dataset is from `r min((pull(penguins, year))), na.rm = FALSE)` to `r max((pull(penguins, year)), na.rm = FALSE)`. 
In this dataset, there were `r count(pull(penguins, sex, female))`
